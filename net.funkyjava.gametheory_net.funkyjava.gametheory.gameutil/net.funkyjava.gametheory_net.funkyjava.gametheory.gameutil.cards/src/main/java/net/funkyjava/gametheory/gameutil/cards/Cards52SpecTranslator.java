...
/**
 * Convenience class make modules with different {@link IntCardsSpec}
 * communicate.
 * 
...
public class Cards52SpecTranslator {
	 ...
	 * 
	 * @param src
	 *            the source cards specification for this translator
	 * @param dest
	 *            the destination cards specification for this translator
	 */
	 ...
	 * 
	 * @param specs1
	 *            the first cards specs
	 * @param specs2
	 *            the second cards specs
