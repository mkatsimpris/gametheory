...
public final class WaughIndexer implements CardsGroupsIndexer {
	...
	/**
	 * Index cards groups. For performance, no check is done on the number of
	 * cards or groups or their validity. The behavior of this method is not
	 * specified for invalid arguments.
	 * 
	 * Groups are represented as long with bits i * 16 + (0 to 12) representing
	 * the presence of the ranks for the arbitrary color i.
	 * 
	 * @param groupsCards
	 *            the cards of the groups to index
	 * @return the index
	 */
	 ...
	 *            the index
	 * @param dest
	 *            the destination array that must have a sufficient length
	 */
	 ...
	 * specified for invalid arguments.
	 * 
	 * Groups must be represented according to the {@link IntCardsSpec} returned
	 * by {@link #getCardsSpec()}.
	 * 
	 * For performance, it's better to use the {@link #index(long[])} if your
	 * cards are already represented as bit masks.
	 * 
	 * @param cardsGroups
	 *            the cards of the groups to index
	 * @return the index
