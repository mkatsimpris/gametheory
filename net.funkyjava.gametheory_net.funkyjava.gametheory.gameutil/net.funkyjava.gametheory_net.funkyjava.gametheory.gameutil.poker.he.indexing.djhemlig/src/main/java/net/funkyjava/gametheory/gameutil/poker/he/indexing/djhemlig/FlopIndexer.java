...
public class FlopIndexer extends Indexer {
	...
	public static final int[] bRank1 = { 0, 12, 23, 33, 42, 50, 57, 63, 68, 72,
			75, 77, 78 };
	public static final int[] bRank2 = { 0, 78, 144, 199, 244, 280, 308, 329,
			344, 354, 360, 363, 364 };
	...
	private void countRankSuits(int[] Rank) {
		...
		if (rankIsoIndex == -1) {
			...
			if (generationDebug) {
				Helper.printArray("", r);
				System.out.println("Num suits:" + f.getSize() + " rankindex:"
						+ rankPatternCount);
			}
