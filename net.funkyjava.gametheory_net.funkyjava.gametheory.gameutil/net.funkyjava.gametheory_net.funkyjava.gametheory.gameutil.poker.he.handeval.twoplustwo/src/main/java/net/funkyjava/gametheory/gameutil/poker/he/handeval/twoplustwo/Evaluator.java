...
public class Evaluator {
	...
	public static void main(String[] args) {
		...
		if (verbose) {
			System.out
					.print("Enumerating hand frequencies and equivalency classes...");
			startTimer = System.currentTimeMillis();
		}
		...
		System.out
				.println("SEVEN-CARD POKER HAND FREQUENCIES AND EQUIVALENCY CLASSES\n");
		...
		for (int i = handEnumerations.length - 1; i >= 0; i--) {
			...
			System.out.printf(" %-17s %15d %15d\n", handDescriptions[i],
					handEnumerations[i], sumEquivalency);
		}
		System.out
				.println(" -------------------------------------------------");
