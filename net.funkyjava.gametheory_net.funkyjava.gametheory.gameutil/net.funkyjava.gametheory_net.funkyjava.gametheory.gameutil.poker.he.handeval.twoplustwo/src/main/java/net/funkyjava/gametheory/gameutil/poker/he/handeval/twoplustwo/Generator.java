...
public class Generator {
	 ...
	 * 
	 * 2c = 1 2d = 14 2h = 27 2s = 40 3c = 2 3d = 15 3h = 28 3s = 41 4c = 3 4d =
	 * 16 4h = 29 4s = 42 5c = 4 5d = 17 5h = 30 5s = 43 6c = 5 6d = 18 6h = 31
	 * 6s = 44 7c = 6 7d = 19 7h = 32 7s = 45 8c = 7 8d = 20 8h = 33 8s = 46 9c
	 * = 8 9d = 21 9h = 34 9s = 47 Tc = 9 Td = 22 Th = 35 Ts = 48 Jc = 10 Jd =
	 * 23 Jh = 36 Js = 49 Qc = 11 Qd = 24 Qh = 37 Qs = 50 Kc = 12 Kd = 25 Kh =
	 * 38 Ks = 51 Ac = 13 Ad = 26 Ah = 39 As = 52
	 * 
	 * 2c = 1 2d = 2 2h = 3 2s = 4 3c = 5 3d = 6 3h = 7 3s = 8 4c = 9 4d = 10 4h
	 * = 11 4s = 12 5c = 13 5d = 14 5h = 15 5s = 16 6c = 17 6d = 18 6h = 19 6s =
	 * 20 7c = 21 7d = 22 7h = 23 7s = 24 8c = 25 8d = 26 8h = 27 8s = 28 9c =
	 * 29 9d = 30 9h = 31 9s = 32 Tc = 33 Td = 34 Th = 35 Ts = 36 Jc = 37 Jd =
	 * 38 Jh = 39 Js = 40 Qc = 41 Qd = 42 Qh = 43 Qs = 44 Kc = 45 Kd = 46 Kh =
	 * 47 Ks = 48 Ac = 49 Ad = 50 Ah = 51 As = 52
	 */
	...
	private static int getHandRank(long key) {
		...
		if (key != 0) {
			...
			for (cardIndex = 0; cardIndex < 7; cardIndex++) {
				...
				hand[cardIndex] = primes[rank] | (rank << 8)
						| (1 << (suit + 11)) | (1 << (16 + rank));
			}
			...
			case 5:
				...
				holdrank = eval_5hand(hand[0], hand[1], hand[2], hand[3],
						hand[4]);
				break;
			...
			case 6:
				...
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[2], hand[3],
										hand[5]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[2], hand[4],
										hand[5]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[3], hand[4],
										hand[5]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[2], hand[3], hand[4],
										hand[5]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[1], hand[2], hand[3], hand[4],
										hand[5]));
				break;
			...
			case 7:
				...
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[2], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[3], hand[4],
				...
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[3], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[1], hand[4], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[2], hand[3], hand[4],
				...
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[2], hand[3], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[2], hand[4], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[0], hand[3], hand[4], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[1], hand[2], hand[3], hand[4],
				...
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[1], hand[2], hand[3], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[1], hand[2], hand[4], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[1], hand[3], hand[4], hand[5],
										hand[6]));
				holdrank = Math
						.min(holdrank,
								eval_5hand(hand[2], hand[3], hand[4], hand[5],
										hand[6]));
				break;
 ...
 * Straight Flush 41584 10 Four of a Kind 224848 156 Full House 3473184 156
 * Flush 4047644 1277 Straight 6180020 10 Three of a Kind 6461620 575 Two Pair
 * 31433400 763 One Pair 58627800 1470 High Card 23294460 407 Invalid Hand 0 0
 * ------------------------------------------------- TOTAL 133784560 4824
 * 
 * BAD!! = 0 High Card = 23294460 Pair = 58627800 Two Pair = 31433400 Three of a
 * Kind = 6461620 Straight = 6180020 Flush = 4047644 Full House = 3473184 Four
 * of a Kind = 224848 Straight Flush = 41584 Total Hands = 133784560
 */
